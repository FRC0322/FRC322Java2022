...
public class RearClimber extends SubsystemBase {
  ...
  private final MotorControllerGroup m_climberMotors = new MotorControllerGroup(m_leftClimberMotor, m_rightClimberMotor);
  /** Creates a new RearClimber. */
  public RearClimber() {
    super();
    /*
    // Set the inversion on the climber motors.  (Until we know if this is necessary, it'll remain commented out.)
