...
public final class Constants {
  ...
  public static final int ADDRESSABLE_LED_PORT = 0, ADDRESSABLE_LED_LENGTH = 300;
  ...
  // RobotContainer.java
  public static final boolean CLASSIC_MODE = false, ROBOT_POWER = false;
  ...
  // RearClimber.java
  public static final int REAR_LEFT_CLIMBER_MOTOR = 10, REAR_RIGHT_CLIMBER_MOTOR = 11;

  // RunFrontCamera.java & RunRearCamera.java
  public static final int VIDEO_WIDTH = 320, VIDEO_HEIGHT = 180, VIDEO_FPS = 15;
