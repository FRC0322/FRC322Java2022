...
public class Limelight {
   ...
   *
   * @param targetHeight = target height in meters, limelightHeight = height of limelight from the
   *     ground in meters, limelightAngle = angle in degrees of the limelight on the robot.
