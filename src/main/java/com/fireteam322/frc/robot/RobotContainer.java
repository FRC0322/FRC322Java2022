...
public class RobotContainer {
  ...
  private final RobotCamera m_rearCamera =
      new RobotCamera("Rear Camera", Constants.REAR_CAMERA_CHANNEL);
  ...
  private final JoystickButton m_visionModeButton =
      new JoystickButton(m_driveStick, F310Controller.Button.kBumperLeft.getValue());
  private final JoystickButton m_driverModeButton =
      new JoystickButton(m_driveStick, F310Controller.Button.kBumperRight.getValue());
  ...
  private final JoystickButton m_brakeButtonJoystick =
      new JoystickButton(m_rightDriveJoystick, Joystick.ButtonType.kTrigger.value);
  private final JoystickButton m_rearClimbButtonJoystick =
      new JoystickButton(m_rightDriveJoystick, Constants.CLIMB_JOYSTICK_BUTTON);
  private final JoystickButton m_frontClimbButtonJoystick =
      new JoystickButton(m_leftDriveJoystick, Constants.CLIMB_JOYSTICK_BUTTON);
  private final JoystickButton m_rearClimbReverseButtonJoystick =
      new JoystickButton(m_rightDriveJoystick, Constants.CLIMB_REVERSE_JOYSTICK_BUTTON);
  private final JoystickButton m_frontClimbReverseButtonJoystick =
      new JoystickButton(m_leftDriveJoystick, Constants.CLIMB_REVERSE_JOYSTICK_BUTTON);
  private final JoystickButton m_visionModeButtonJoystick =
      new JoystickButton(m_rightDriveJoystick, Constants.VISION_MODE_BUTTON);
  private final JoystickButton m_driverModeButtonJoystick =
      new JoystickButton(m_leftDriveJoystick, Constants.VISION_MODE_BUTTON);
  ...
  private final JoystickButton m_LEDOnButton =
      new JoystickButton(m_manipulatorStick, F310Controller.Button.kStart.getValue());
  private final JoystickButton m_LEDBlinkButton =
      new JoystickButton(m_manipulatorStick, F310Controller.Button.kStickLeft.getValue());
  private final JoystickButton m_LEDOffButton =
      new JoystickButton(m_manipulatorStick, F310Controller.Button.kBack.getValue());
  private final JoystickButton m_LEDDefaultButton =
      new JoystickButton(m_manipulatorStick, F310Controller.Button.kStickRight.getValue());
  ...
  public RobotContainer() {
    ...
    if (Constants.CLASSIC_MODE) {
      m_chassis.setDefaultCommand(
          new DriveWithJoysticks(
              () -> (m_leftDriveJoystick.getY()),
              () -> m_rightDriveJoystick.getY(),
              m_chassis,
              m_brakeButtonJoystick));
    } else {
      m_chassis.setDefaultCommand(
    ...
    m_limelightCamera.setDefaultCommand(
        new LimelightLightModeControl(m_limelightCamera, Limelight.LightMode.kforceOff));

    m_rearCamera.setDefaultCommand(new RunRearCamera(m_rearCamera));

    if (Constants.ROBOT_POWER) m_robotPower.setDefaultCommand(new StartRobotPower(m_robotPower));
  ...
  private void configureButtonBindings() {
    if (Constants.CLASSIC_MODE) {
      m_visionModeButtonJoystick.whileActiveOnce(
          new LimelightCameraModeControl(m_limelightCamera, CameraMode.kvision));
      m_driverModeButtonJoystick.whileActiveOnce(
          new LimelightCameraModeControl(m_limelightCamera, CameraMode.kdriver));
      m_rearClimbButtonJoystick.whileActiveOnce(
          new RunRearClimber(m_rearClimber, Constants.CLIMBER_SPEED));
      m_rearClimbReverseButtonJoystick.whileActiveOnce(
          new RunRearClimber(m_rearClimber, Constants.CLIMBER_REVERSE_SPEED));
      m_frontClimbButtonJoystick.whileActiveOnce(
          new RunFrontClimber(m_frontClimber, Constants.CLIMBER_SPEED));
      m_frontClimbReverseButtonJoystick.whileActiveOnce(
          new RunFrontClimber(m_frontClimber, Constants.CLIMBER_REVERSE_SPEED));
    } else {
      m_visionModeButton.whileActiveOnce(
          new LimelightCameraModeControl(m_limelightCamera, CameraMode.kvision));
      m_driverModeButton.whileActiveOnce(
          new LimelightCameraModeControl(m_limelightCamera, CameraMode.kdriver));
    ...
    // m_shooterButton.whileActiveOnce(new RunShooter(m_shooter, () -> Constants.SHOOTER_SPEED),
    // true);

    runBottomeShooter
        .setDeviceID(Constants.LEFT_SHOOTER_MOTOR)
        .setSpeed(Constants.SHOOTER_SPEED)
        .setJoyStick(new JoystickButton(m_manipulatorStick, F310Controller.Button.kX.getValue()))
        .setButtonActionAndSpeed(MotorBuilder.ACTION_HELD, Constants.SHOOTER_SPEED)
        .setButtonActionAndSpeed(MotorBuilder.ACTION_RELEASED, 0.0);
    ...
    m_LEDOffButton.whileActiveOnce(
        new LimelightLightModeControl(m_limelightCamera, LightMode.kforceOff));
    m_LEDBlinkButton.whileActiveOnce(
        new LimelightLightModeControl(m_limelightCamera, LightMode.kforceBlink));
    m_LEDOnButton.whileActiveOnce(
        new LimelightLightModeControl(m_limelightCamera, LightMode.kforceOn));
  }
